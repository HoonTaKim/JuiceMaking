...
public class FruitInfo : MonoBehaviour
{
    ...
    private void Awake()
    {
        fruitSpriteList = GameManager.Inst.Get_FruitTexterList;
        Debug.Log("fruitSpriteList : " + fruitSpriteList);
        Debug.Log(fruitSpriteList.Count);
